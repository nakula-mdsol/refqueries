--Cumulative SDV Counts and Status at Item level for Study_uuid ='11EDD461333B3E0998110E1498653597' and Begin date of '2024-01-21'
...
--Verified Dates at Item level for Study_uuid ='11EDD461333B3E0998110E1498653597' and Begin date of '2024-01-21' and End date of '2024-04-21'
(select        stu.STU_uuid,
              stuenv.STU_ENV_uuid, 
              cty.CTY_uuid,
              ss.STU_SITE_uuid,
...
----UnVerified Dates at Item level for Study_uuid ='11EDD461333B3E0998110E1498653597' and Begin date of '2024-01-21' and End date of '2024-04-21'
(
select        stu.STU_uuid,
              stuenv.STU_ENV_uuid, 
              cty.CTY_uuid,
